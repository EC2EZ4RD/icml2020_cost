...
from envs.mpe import CurriculumHRLComEnv, eval_fn
from models.action_dist import TorchHomogeneousMultiActionDistribution
from models import InvariantAttComModel
from agents.teachers.callbacks import TeacherCallback, TaskwiseTeacherCallback

EXAMPLE_USAGE = """
python run_curriculum_hrl_att_com_mpe.py
"""
...
def create_args():
    ...
    parser.add_argument(
        "-f",
        "--config-file",
        default="./configs/mpe_att_com_curriculum_hrl.yaml",
        type=str,
    ...
    parser.add_argument("--teacher", type=str,
                        choices=["agent_num_bandit", "discrete_bandit", "simple_bandit", "task_wise_bandit",
                                 "eval_on_5v5_bandit", "contextual_bandit"], default=None)
...
class CustomMetricsCallback(DefaultCallbacks):
    def on_episode_end(self,
        ...
        episode.custom_metrics["cover_rate"] = episode.last_info_for("high_level_policy")["cover_rate"]
        episode.custom_metrics["num_agents"] = episode.last_info_for("high_level_policy")["num_agents"]
...
if __name__ == "__main__":
    ...
    teacher = TEACHER_LIST[args.teacher].options(
        ...
        config=dict(**args.teacher_config, **{"env": args.env, "scenario": args.scenario})
        , seed=args.seed)
    ...
    register_env(env_name, lambda cfg: CurriculumHRLComEnv(cfg))

    callback = CALLBACK_LIST[args.teacher]
    ...
    env_config = dict(**args.env_config, **{
        ...
        "custom_configs": {
            ...
            "target_num_agents": args.env_config["target_num_agents"],
            "max_num_agents": args.env_config["max_num_agents"],
    ...
    temp_env = CurriculumHRLComEnv(env_config)
    ...
    config = {
        "framework": "torch",
        "log_level": "INFO",
        "callbacks": MultiCallbacks([callback, CustomMetricsCallback]),
        ...
        "evaluation_config": {
            "env_config": dict(
                **{
                    "num_agents": args.env_config["target_num_agents"],
