...
from envs.mpe import VACLEPMultiAgentCurriculumMPE, eval_fn

EXAMPLE_USAGE = """
python run_vacl_ep_shared_mpe.py
"""
...
def create_args():
    ...
    parser.add_argument(
        "-f",
        "--config-file",
        default="../configs/mpe_vacl_ep_shared.yaml",
        type=str,
...
if __name__ == "__main__":
    ...
    register_env(env_name, lambda cfg: VACLEPMultiAgentCurriculumMPE(cfg))
