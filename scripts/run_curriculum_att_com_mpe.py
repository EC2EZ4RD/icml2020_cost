...
from envs.mpe import CurriculumComMPE, eval_fn
from agents.teachers import TEACHER_LIST, CALLBACK_LIST

EXAMPLE_USAGE = """
python run_curriculum_att_com_mpe.py
"""
...
def create_args():
    ...
    parser.add_argument(
        "-f",
        "--config-file",
        default="../configs/mpe_att_com_curriculum.yaml",
        type=str,
...
if __name__ == "__main__":
    ...
    register_env(env_name, lambda cfg: CurriculumComMPE(cfg))
