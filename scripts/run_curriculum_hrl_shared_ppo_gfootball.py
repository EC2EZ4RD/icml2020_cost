...
from envs.gfootball import FootballCurriculumHierarchicalMultiAgentEnv, eval_fn
from agents.teachers import TEACHER_LIST, CALLBACK_LIST

EXAMPLE_USAGE = """
python run_curriculum_hrl_shared_ppo_gfootball.py
"""
...
def create_args():
    ...
    parser.add_argument(
        "-f",
        "--config-file",
        default="../configs/gfootball_shared_ppo_curriculum_hrl.yaml",
        type=str,
...
class CustomMetricsCallback(DefaultCallbacks):
    def on_episode_end(self,
        ...
        episode.custom_metrics["score"] = episode.last_info_for("high_level_0")["score"]
...
if __name__ == "__main__":
    ...
    register_env(env_name, lambda cfg: FootballCurriculumHierarchicalMultiAgentEnv(cfg))
    ...
    temp_env = FootballCurriculumHierarchicalMultiAgentEnv(env_config)
