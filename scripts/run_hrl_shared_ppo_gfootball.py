...
from envs.gfootball import FootballHierarchicalMultiAgentEnv, eval_fn

EXAMPLE_USAGE = """
python run_hrl_shared_ppo_gfootball.py
"""
...
def create_args():
    ...
    parser.add_argument(
        "-f",
        "--config-file",
        default="../configs/gfootball_shared_ppo_hrl.yaml",
        type=str,
...
if __name__ == "__main__":
    ...
    register_env(env_name, lambda cfg: FootballHierarchicalMultiAgentEnv(cfg))
    ...
    temp_env = FootballHierarchicalMultiAgentEnv(env_config)
