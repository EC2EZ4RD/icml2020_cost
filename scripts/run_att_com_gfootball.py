...
from envs.gfootball import FootballMultiAgentComEnv, eval_fn
...
EXAMPLE_USAGE = """
python run_att_com_gfootball.py
"""


def create_args():
    parser = argparse.ArgumentParser(
        description="Train gfootball agents with attention-based communication.",
        epilog=EXAMPLE_USAGE)
    parser.add_argument(
        "-f",
        "--config-file",
        default="../configs/gfootball_att_com.yaml",
        type=str,
        help="Use config options from this yaml file.")
    parser.add_argument("--num-agents", type=int, default=None)
    parser.add_argument("--num-gpus", type=int, default=None)
    parser.add_argument("--num-workers", type=int, default=None)
    parser.add_argument("--scenario", type=str, choices=["5_vs_5", "academy_3_vs_1_with_keeper"], default=None)
    parser.add_argument(
        "--stop-timesteps",
        type=int,
        default=None,
...
if __name__ == "__main__":
    ...
    register_env(env_name, lambda cfg: FootballMultiAgentComEnv(cfg))
