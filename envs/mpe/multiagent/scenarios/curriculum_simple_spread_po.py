...
class Scenario(BaseScenario):
    def make_world(self, config):
        ...
        assert self.num_observable_agents < num_agents
    ...
    def observation(self, agent, world):
        ...
        for entity in world.landmarks:  # world.entities:
            ...
            entity_pos.append(tmp_pos)  # whether covered
        entity_pos = heapq.nsmallest(self.num_observable_agents, entity_pos, key=lambda s: np.sum(np.square(s)))
        # entity colors
        entity_color = []
        for entity in world.landmarks:  # world.entities:
        ...
        other_pos = heapq.nsmallest(self.num_observable_agents, other_pos, key=lambda s: np.sum(np.square(s)))
        comm = heapq.nsmallest(self.num_observable_agents, comm, key=lambda s: np.sum(np.square(s)))
