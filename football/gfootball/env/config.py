...
class Config(object):
    ...
    def __init__(self, values=None, task: dict = None):
        self._values = {
            'action_set': 'default',
    ...
    def NewScenario(self, inc=1, task: dict = None):
        ...
        self._scenario_cfg = scenario_builder.Scenario(self, task).ScenarioConfig()
